...
def get_token():
    ...
    try:
        # Tu też udajemy przeglądarkę, żeby nas nie odrzucili przy logowaniu
        headers = {
...
def search_allegro(token, phrase):
    ...
    try:
        ...
        # Jeśli blokada 403 - pokaż komunikat
